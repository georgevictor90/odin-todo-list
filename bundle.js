...
function showEditProjectForm() {
  ...
  editProjectFormSaveBtn.addEventListener('click', () => {
    console.log(_currentProjectFunctions__WEBPACK_IMPORTED_MODULE_5__.userProjects);
    let proj = _currentProjectFunctions__WEBPACK_IMPORTED_MODULE_5__.userProjects.find(function(project) {
...
function editProject(proj) {
  ...
  (0,_newProjectForm_newProjectForm__WEBPACK_IMPORTED_MODULE_8__.setProjectFilter)(proj);
  ...
  // update menu
  (0,_newProjectForm_newProjectForm__WEBPACK_IMPORTED_MODULE_8__.updateProjectsSectionList)();
}
...
/* harmony import */ var _currentProjectFunctions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../currentProjectFunctions */ "./src/currentProjectFunctions.js");
/* harmony import */ var _goToPage_goToPage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../goToPage/goToPage */ "./src/goToPage/goToPage.js");
/* harmony import */ var _assets_icons_mycircle_svg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../assets/icons/mycircle.svg */ "./src/assets/icons/mycircle.svg");
/* harmony import */ var _newProjectForm_newProjectForm__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../newProjectForm/newProjectForm */ "./src/newProjectForm/newProjectForm.js");
...
/* harmony import */ var _currentProjectFunctions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../currentProjectFunctions */ "./src/currentProjectFunctions.js");
/* harmony import */ var _factoryFunctions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../factoryFunctions */ "./src/factoryFunctions.js");
/* harmony import */ var _goToPage_goToPage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../goToPage/goToPage */ "./src/goToPage/goToPage.js");
...
function showTaskEditor() {
  ...
  submit.addEventListener('click', () => {
    ...
    const task = (0,_factoryFunctions__WEBPACK_IMPORTED_MODULE_4__.newTodo)(newTaskTitle.value, newTaskDescription.value, newTaskDate.value);
    task.id = Math.random().toString(16).slice(2);
    for (let i = 0; i < _currentProjectFunctions__WEBPACK_IMPORTED_MODULE_3__.userProjects.length; i++) {
      if (_currentProjectFunctions__WEBPACK_IMPORTED_MODULE_3__.userProjects[i].name === newTaskFolder.value) {
        _currentProjectFunctions__WEBPACK_IMPORTED_MODULE_3__.userProjects[i].addTodos(task);
      }
    };
    for (let i = 0; i < _currentProjectFunctions__WEBPACK_IMPORTED_MODULE_3__.defaultSections.length; i++) {
      if (_currentProjectFunctions__WEBPACK_IMPORTED_MODULE_3__.defaultSections[i].name === newTaskFolder.value) {
        _currentProjectFunctions__WEBPACK_IMPORTED_MODULE_3__.defaultSections[i].addTodos(task);
      } 
    };
    if (newTaskDate.value === today) {
      _currentProjectFunctions__WEBPACK_IMPORTED_MODULE_3__.defaultSections[1].addTodos(task)
    };
    console.log(_currentProjectFunctions__WEBPACK_IMPORTED_MODULE_3__.defaultSections[1]);
    (0,_goToPage_goToPage__WEBPACK_IMPORTED_MODULE_5__.showTasks)();
    clearForm();
    // goToPage();
  })
}
...
function updateFolderButtonOptions() {
  ...
  const option = document.createElement('option');
  option.textContent = _currentProjectFunctions__WEBPACK_IMPORTED_MODULE_3__.defaultSections[0].name;
  option.value = _currentProjectFunctions__WEBPACK_IMPORTED_MODULE_3__.defaultSections[0].name;
  folderButton.appendChild(option);

  _currentProjectFunctions__WEBPACK_IMPORTED_MODULE_3__.userProjects.forEach(project => {
    const option = document.createElement('option');
